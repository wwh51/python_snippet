...
class LoginPasswordError(Exception):
    def __init__(self, message):
        if type(message) != type("") or message == "": self.message = "Incorrect account/password"
        else: self.message = message
        Logging.error(self.message)

class NetworkError(Exception):
    def __init__(self, message):
        if type(message) != type("") or message == "": self.message = "network error"
        else: self.message = message
        Logging.error(self.message)
class AccountError(Exception):
    def __init__(self, message):
        if type(message) != type("") or message == "": self.message = "account error"
        else: self.message = message
        Logging.error(self.message)
...
def download_captcha():
    ...
    sys.stdout.write(termcolor.colored("Please input verify code: ", "cyan") )
...
if __name__ == "__main__":
    login(account="wang@gmail.com", password="")
    #login()
